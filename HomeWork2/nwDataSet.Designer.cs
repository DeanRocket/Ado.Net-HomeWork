...
namespace HomeWork2.nwDataSetTableAdapters {
...
SELECT CategoryID, CategoryName, Description, Picture FROM Categories WHERE (CategoryID = @CategoryID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::HomeWork2.Properties.Settings.Default.NorthwindConnectionString;
        }
...
SELECT ProductID, ProductName, SupplierID, CategoryID, QuantityPerUnit, UnitPrice, UnitsInStock, UnitsOnOrder, ReorderLevel, Discontinued FROM Products WHERE (ProductID = @ProductID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = @"SELECT          P.ProductID, P.ProductName, P.UnitPrice, P.Discontinued, c.CategoryName, c.Picture
FROM              Products AS P INNER JOIN
                            Categories AS c ON P.CategoryID = c.CategoryID
WHERE          (c.CategoryName = @aaa)";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@aaa", global::System.Data.SqlDbType.NVarChar, 15, global::System.Data.ParameterDirection.Input, 0, 0, "CategoryName", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int FillByCategory(nwDataSet.ProductsDataTable dataTable, string aaa) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((aaa == null)) {
                throw new global::System.ArgumentNullException("aaa");
            }
            else {
                this.Adapter.SelectCommand.Parameters[0].Value = ((string)(aaa));
            }
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        public virtual nwDataSet.ProductsDataTable GetDataByCategory(string aaa) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((aaa == null)) {
                throw new global::System.ArgumentNullException("aaa");
            }
